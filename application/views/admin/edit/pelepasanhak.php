...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-fw fa-map-marker-alt"></i> Edit Pelepasan Hak</h1>
    <br>
        ...
        <div class="col-md-10 text-center">
            ...
            <div class="form-group text-start">
                ...
                <div class="form-group text-start">
                    ...
                    <input type="date" class="form-control form-control-user" id="tanggal_kwitansi" name="tanggal_kwitansi" value="<?= $pelhak['tanggal_kwitansi'];?>">
                    <?= form_error('tanggal_kwitansi', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>

                <div class="form-group text-start">
                    <p class="ms-3 mb-0">Tanggal Pembayaran</p>
                    <input type="date" class="form-control form-control-user" id="tanggal_pembayaran" name="tanggal_pembayaran" value="<?= $pelhak['tanggal_pembayaran'];?>">
                ...
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="nomor_rekening" name="nomor_rekening" value="<?= $pelhak['nomor_rekening'];?>">
                    <?= form_error('nomor_rekening', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>

                <div class="form-group text-start">
                    <p class="ms-3 mb-0">Nama Bank</p>
                    <input type="text" class="form-control form-control-user" id="nama_bank" name="nama_bank" value="<?= $pelhak['nama_bank'];?>">
