...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-fw fa-map-marker-alt"></i> Edit Kegiatan</h1>
    <br>
        ...
        <div class="col-md-10 text-center">
            <form class="user" method="POST" action="">
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="nomor_penlok" name="nomor_penlok" value="<?= $kegiatan['id_penlok'];?>">
                    <?= form_error('nomor_penlok', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>

                <div class="form-group text-start">
                    <p class="ms-3 mb-0">Nomor Kegiatan</p>
                    <input type="text" class="form-control form-control-user" id="nomor_kegiatan" name="nomor_kegiatan" value="<?= $kegiatan['nomor_kegiatan'];?>">
                    <?= form_error('nomor_kegiatan', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>

                <div class="form-group text-start">
                    <p class="ms-3 mb-0">Rencana Pembangunan</p>
                    <input type="text" class="form-control form-control-user" id="rencana_penggunaan" name="rencana_penggunaan" value="<?= $kegiatan['rencana_penggunaan'];?>">
                    <?= form_error('rencana_penggunaan', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>

                <div class="form-group text-start">
                    <p class="ms-3 mb-0">Nama Kegiatan</p>
                    <input type="text" class="form-control form-control-user" id="nama_kegiatan" name="nama_kegiatan" value="<?= $kegiatan['nama_kegiatan'];?>">
