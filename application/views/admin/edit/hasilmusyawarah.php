...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-fw fa-map-marker-alt"></i> Edit Hasil Musyawarah</h1>
    <br>
        ...
        <div class="col-md-10 text-center">
            <form class="user" method="POST" action="">
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="id_bidang_tanah" name="id_bidang_tanah" value="<?= $hamus['id_bidang_tanah'];?>">
                ...
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="nama_penggarap" name="nama_penggarap" value="<?= $hamus['nama_penggarap'];?>">
