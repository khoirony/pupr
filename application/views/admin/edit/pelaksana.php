        ...
        <div class="col-md-10 text-center">
            <form class="user" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="golongan" name="golongan" value="<?= $pelaksana['golongan'];?>">
                ...
                <div class="form-group text-start">
                    ...
                    <select class="custom-select rounded-pill px-3" id="satgas" name="satgas">
                        <option value="<?= $pelaksana['satgas'];?>"><?= $pelaksana['satgas'];?></option>
