...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-fw fa-map-marker-alt"></i> Tambah Penilaian Tanah</h1>
    <br>
        ...
        <div class="col-md-10 text-center">
            <form class="user" method="POST" action="">
                ...
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="penilai_tanah" name="penilai_tanah">
                ...
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="nilai_bangunan" name="nilai_bangunan">
