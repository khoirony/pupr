        ...
        <div class="col-md-10 text-center">
            <form class="user" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group text-start">
                    ...
                    <input type="text" class="form-control form-control-user" id="uang_harian" name="uang_harian">
                    <?= form_error('uang_harian', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>

                <div class="form-group text-start">
                    <p class="ms-3 mb-0">Pajak</p>
                    <input type="text" class="form-control form-control-user" id="pajak" name="pajak">
